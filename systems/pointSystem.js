...
(function() {
    ...
    $.bind('command', function(event) {
        ...
        /**
         * @commandpath points - Announce points in chat when no parameters are given. - Viewer
         */
        if (command.equalsIgnoreCase('points') || command.equalsIgnoreCase('point') || command.equalsIgnoreCase(pointNameMultiple) || command.equalsIgnoreCase(pointNameSingle)) {
            if (!action) {
                ...
                /**
                 * @commandpath points [user] [username] - Check the points of the user given by username - Viewer
                 */
                ...
                /**
                 * @commandpath points add [username] [amount] - Add an amount of points to a user's balance - Administrator
                 */
                ...
                /**
                 * @commandpath points take [username] [amount] - Take an amount of points from the user's balance - Administrator
                 */
                ...
                /**
                 * @commandpath points set [username] [amount] - Set the user's points balance to an amount - Administrator
                 */
                ...
                /**
                 * @commandpath points all [amount] - Send an amount of points to all users in the chat - Administrator
                 */
                ...
                /**
                 * @commandpath points setname single [name] - Set the points name for single points - Administrator
                 * @commandpath points setname multiple [name] - Set the points name for plural points - Administrator
                ...
                /**
                 * @commandpath points setgain [amount] - Set the amount of points gained per payout interval while the channel is online, can be overriden by group settings - Administrator
                 */
                ...
                /**
                 * @commandpath points setofflinegain [amount] - Set the amount of points gained per interval while the channel is offline, can be overridden by group settings - Administrator
                 */
                ...
                /**
                 * @commandpath points setinterval [minutes] - Set the points payout interval for when the channel is online - Administrator
                 */
                ...
                /**
                 * @commandpath points setofflineinterval [minutes] - Set the points payout interval for when the channel is offline - Administrator
                 */
...
//        }
        ...
        //     $.say($.whisperPrefix(sender) + $.lang.get('pointsystem.gift.success', $.username.resolve(sender), getPointsString(parseInt(args[1])), $.username.resolve(args[0])));
        //     $.say($.whisperPrefix($.username.resolve(args[0])) + $.lang.get('pointsystem.gift.received', $.username.resolve(sender), getPointsString(parseInt(args[1])), $.username.resolve(args[0])));
        // }
    });
    ...
    $.bind('initReady', function() {
        if ($.bot.isModuleEnabled('./systems/pointSystem.js')) {
            ...
            //$.registerChatCommand('./systems/pointSystem.js', 'gift', 2);
