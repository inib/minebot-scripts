...
(function() {
    ...
    $.bind('command', function(event) {
        ...
        /**
         * @commandpath top - By default it will disaplay the top5 people with the most points. This can be changed.- Viewer
         */
        ...
        /**
         * @commandpath toptime - By default it will disaplay the top5 people with the most time. This can be changed.- Viewer
         */
        ...
        /**
         * @commandpath topamount - Set how many people who up in the !top points list. - Administrator
         */
        ...
        /**
         * @commandpath toptimeamount - Set how many people who up in the !toptime list. - Administrator
         */
