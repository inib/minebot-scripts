...
(function() {
    ...
    $.bind('command', function(event) {
        ...
        /**
         * @commandpath coolcom [command or keyword] [seconds] - Sets a cooldown in seconds for a command or a keyword. Use -1 for seconds to remove it. This also applies for the per-user cooldown. - Administrator
         */
        ...
        /**
         * @commandpath toggleperusercooldown - Enables/Disables the per-user command cooldown. - Administrator
         */
        ...
        /**
         * @commandpath globalcooldowntime [seconds] - Sets the global cooldown time in seconds. - Administrator
         */
