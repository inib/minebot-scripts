...
$.lang.register('subscribehandler.resub.msg.usage', 'Anleitung: !resubmessage (Nachricht) - Tags: (name), (months) and (reward)');
$.lang.register('subscribehandler.resub.msg.noreward.set', 'Resubscriber welcome message set for no rewards!');
$.lang.register('subscribehandler.resub.msg.noreward.usage', 'Anleitung: !resubmessage (message) - Tags: (name) (months)');
